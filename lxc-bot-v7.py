...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'MTUwMDUxNDc5NDIxNjYyMDIxNA.GCk3UA.7TL3gJHywEqtanhCXhBnW6P2EqXalLq3ajs7Fw')
BOT_NAME = os.getenv('BOT_NAME', 'stonenodes')
PREFIX = os.getenv('PREFIX', '.')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '100.85.165.37')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1461922708672745582'))
VPS_USER_ROLE_ID = int(os.getenv('VPS_USER_ROLE_ID', '1523214504182288508'))
DEFAULT_STORAGE_POOL = os.getenv('DEFAULT_STORAGE_POOL', 'default')
BOT_VERSION = os.getenv('BOT_VERSION', '1.0')
BOT_DEVELOPER = os.getenv('BOT_DEVELOPER', 'lasharigamer')
